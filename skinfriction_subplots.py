...
#            plt.show()
        ...
        vorticitySolution = cal_vorticity(sj1, sj3, sk1, sk3, fullSolution[0][1], fullSolution[0][2])
...
#        ax.scatter(x[jsta:jend,kw],         vorticity[jsta:jend,kw], s=80, facecolors='none', edgecolors='r')
        ...
        ax.plot(   x[jsta:jend,kw], xm_inf/re_inf/1e6*vorticitySolution[jsta:jend,kw]*( -normal_y[jsta:jend]*tangent_x[jsta:jend]+normal_x[jsta:jend]*tangent_y[jsta:jend] )/(pt_inf-p_inf), "r-", label="DNN")
        ax.scatter(x[jsta:jend,kw], xm_inf/re_inf/1e6*vorticity[jsta:jend,kw]*( -normal_y[jsta:jend]*tangent_x[jsta:jend]+normal_x[jsta:jend]*tangent_y[jsta:jend]         )/(pt_inf-p_inf), s=80, facecolors='none', edgecolors='k', label="CFD")
...
#            ins = ax.inset_axes([0.5, 0.6, 0.4, 0.4])
        ...
        plt.show()
        #fig.savefig('./results_test_skinfriction/vort_'+files[n][:-4]+'.eps', format='eps', dpi=300)
        #fig.savefig('./results_test_skinfriction/vort_'+files[n][:-4]+'.png', format='png', dpi=300)
#plt.ylim(0.55,0.9)
